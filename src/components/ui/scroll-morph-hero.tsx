            ...
            >
                ...
                >
                    <img
                        ...
                        loading="lazy"
                        // Hide a broken image so the gray placeholder shows instead
                ...
                >
                    <div className="text-center">
                        <p className="text-[8px] font-bold text-amber-400 uppercase tracking-widest mb-1">عرض</p>
                        <p className="text-xs font-medium text-white">التفاصيل</p>
                    </div>
                </div>
            </motion.div>
        </motion.div>
...
// Food / coffee / sweets imagery for the "Top Ten" (توب تن) shop.
// The first dozen IDs are the same verified Unsplash photos already used on the
// homepage; the rest are long-standing food/coffee stock photos.
const IMAGES = [
    ...
    "https://images.unsplash.com/photo-1607478900766-efe13248b125?auto=format&fit=crop&w=400&q=80",
            ...
            <div className="flex h-full w-full flex-col items-center justify-center perspective-1000">
                ...
                >
                    ...
                    <p className="text-sm md:text-base text-gray-600 max-w-lg leading-relaxed">
                        تشكيلة منتقاة من صناعة الأسر المنتجة — أكل شعبي، حلويات، وقهوة بنكهة بيتية أصيلة. <br className="hidden md:block" />
                        اسحب لتتصفّح ما نقدّمه على رفوف توب تن.
                    </p>
                </motion.div>
